...
const iconMap: Record<string, typeof Sparkle | typeof Tag | typeof Paintbrush | typeof Blocks | typeof LineChart | typeof Wallet> = {
  sparkle: Sparkle,
  tag: Tag,
  ...
  <section id="benefits" class="container py-24 sm:py-32">
    <div class="grid lg:grid-cols-2 place-items-center lg:gap-24">
      <div>
        ...
        <h2 class="text-3xl md:text-4xl font-bold mb-4">Your Shortcut to Success</h2>
