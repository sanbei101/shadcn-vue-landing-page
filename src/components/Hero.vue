    ...
    <div class="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
      <div class="text-center space-y-8">
        ...
        <div class="max-w-screen-md mx-auto text-center text-5xl md:text-6xl font-bold">
          <h1>
            Experience the
            <span class="text-transparent bg-gradient-to-r from-[#D247BF] to-primary bg-clip-text">Shadcn/Vue </span>
            landing page
          </h1>
        </div>
      ...
      <div class="relative group mt-14">
        ...
        <!-- gradient effect img -->
        <div
          class="absolute bottom-0 left-0 w-full h-20 md:h-28 bg-gradient-to-b from-background/0 via-background/50 to-background rounded-lg"></div>
      </div>
    </div>
  </section>
</template>
...
@keyframes img-border-animation {
  from {
    border-top-color: rgba(var(--primary), 0.1);
  }
