...
<template>
  <section id="features" class="container py-24 sm:py-32">
    <div class="text-center mb-8">
      ...
      <h2 class="text-3xl md:text-4xl text-center font-bold">Step-by-Step Process</h2>
    </div>
    ...
    <div class="lg:w-[80%] mx-auto relative">
      <div
        ...
        <img :src="image" :alt="`Image describing ${title} `" className="w-[150px]  md:w-[250px] lg:w-[300px] mx-auto -scale-x-100 " />
        <div
          :class="[
